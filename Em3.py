...
def listgrup():
    listGrup =  """🔰คำสั่งตั้งค่า ແπ๊এπနະລ่❂થ🔰
...
def socmedia():
    socMedia = """💠คำสั่งแทค ແπ๊এπနະລ่❂થ💠
📚คท @ ➠ แทคคนที่จะเอาคท
📚มิด @  ➠ ลงmidคนอื่น
📚ชื่อ @ ➠ ลงชื่อคนอื่น
📚ตัส @ ➠ ลงตัสคนอื่น
...
def helpkicker():
    helpKicker = """📱คำสั่งค้นหา ແπ๊এπနະລ่❂થ📱
...
def helpsetting():
    helpSetting = """⚓คำสั่งกลุ่ม ແπ๊এπနະລ่❂થ⚓
🔊 กลุ่ม ➠ ข้อมูลกลุ่ม
🔊 ไอดีกลุ่ม ➠ไอดีห้อง
🔊 ชื่อกลุ่ม ➠ ชื่อห้อง
...
def helptexttospeech():
    helpTextToSpeech =   """💥คำสั่งเลียนแบบ ແπ๊এπနະລ่❂થ💥
❇ เลียนแบบ on/off 
❇ เลียนแบบ 
❇ เพิ่มเลียนแบบ (@) 
❇ ลบเลียนแบบ (@)"""
...
def helplanguange():
    helpLanguange =    """🌟คำสั่งล่องหน ແπ๊এπနະລ่❂થ🌟
ℹ!แทค
ℹ!มิด
ℹ!คท"""
...
#==============================================================================#   
                    ...
                    with requests.session() as web:
                        ...
                        ret_ = "╔══[ ผลการค้นหาของ 💈ແπ๊এπနະລ่❂થ💈 ]"
                        datas = []
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ พี่นี่ไลค์เลย👍")
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"กูว่ามึงอาการหนักนะเนี๊ย เชิญมึงไปรับยาที่ช่อง2!!. อิอิ😝😝")				
